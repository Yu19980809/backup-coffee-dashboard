...
const UserGroup = () => {
  ...
  const handleModifyGroup = () => {
    dispatch( modifyGroup( { groupId: clickedRow._id, newName: newGroupName } ) )
      .then( res => {
        const newGroups = groups.map( item => item._id === res._id ? res : item )
        setGroups( newGroups )
  ...
  const handleAddGroup = () => {
    dispatch( addGroup( { groupName: addGroupName } ) )
      .then( res => {
